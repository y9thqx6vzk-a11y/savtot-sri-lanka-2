    ...
    <footer className="bg-teal-900 text-teal-100 py-12 mt-12 relative" dir={lang === 'he' ? 'rtl' : 'ltr'}>
      <div className="container mx-auto px-6 grid md:grid-cols-3 gap-8 text-center md:text-start">
        ...
        <div>
          ...
          <div className="mt-10 border-t border-teal-800/50 pt-6">
            <p className="font-medium text-teal-200 mb-4 text-sm">{lang === 'he' ? 'תוכלו למצוא אותנו ב:' : 'You can find us at:'}</p>
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
              <a 
                href="https://www.instagram.com/srilankasavtot/" 
                target="_blank" 
                rel="noreferrer"
                className="px-5 py-2.5 bg-white/10 rounded-xl flex items-center justify-center gap-3 hover:bg-orange-500 hover:text-white cursor-pointer transition-all hover:-translate-y-1"
                title="Instagram"
              >
              ...
              <a 
                href="https://www.facebook.com/share/g/1Dt8BR383e/" 
                target="_blank" 
                rel="noreferrer"
                className="px-5 py-2.5 bg-white/10 rounded-xl flex items-center justify-center gap-3 hover:bg-orange-500 hover:text-white cursor-pointer transition-all hover:-translate-y-1"
                title="Facebook"
              >
                ...
                <span className="font-bold tracking-wide">Facebook</span>
              </a>
            </div>
          </div>
        </div>
