...
const contentData = {
  he: {
    ...
    itinerary: {
      ...
      days: [
        { day: '30/8', title: "הגעה וסיגיריה", desc: "הגעה לשדה התעופה של קולומבו בשעה 16:00. נסיעה לסיגיריה, 3 שעות, ולינה." },
        { day: '30/8', title: "סיגיריה", desc: "1. טיפוס למבצר סלע האריה של סיגיריה עם הזריחה.\nארוחת בוקר\n2. ביקור בגלריות אומנות.\nארוחת צהריים\n3. ספארי פילים (הכי טוב בין 3 ל-6 אחה\"צ - כשהחיות יותר פעילות).\n4. ספא איורוודי או סיור כפרי כתחליף עם עצירה לתה.\nארוחת ערב\nלינה בסיגיריה." },
        { day: '31/8', title: "קיטוגלה ונוראווה אליה", desc: "1. טיול זריחה בסלע פידורנגלה (אופציונלי).\nארוחת בוקר\nנסיעה לקיטוגלה (4 שעות).\nארוחת צהריים\n2. רפטינג וקניונינג בקיטוגלה / [פעילות חלופית] טיול ביער הגשם או מערת בלילנה.\nנסיעה לנוראווה אליה (שעתיים).\nארוחת ערב\nלינה בנוראווה אליה." },
        { day: '1/9', title: "אלה", desc: "1. יוגת בוקר.\nארוחת בוקר\n2. טיול רגלי - או סביב אגם גרגורי או הפארק הלאומי הורטון פליינס \"סוף העולם\".\nארוחת צהריים\n3. רכבת לאלה מננו אויה (התחנה הקרובה לנוראווה אליה) - 12:45 - 2.5 שעות (הוואן נוסע).\n4. ביקור בגשר תשע הקשתות - קפה.\n5. מפל נסתר מתחת לגבעות של העיירה אלה, טרק דרך שדות אורז בגובה רב וג\'ונגל סלעי לשחייה בבריכות הטבעיות של המפל.\nארוחת ערב\nלינה באלה." },
        { day: '2/9', title: "ארוגם ביי", desc: "1. טיול רגלי - פסגת אדם הקטנה.\nארוחת בוקר\n2. אומגה.\nארוחת צהריים\n3. הליכה בשדות תה / סיור במפעל תה.\n4. שיטוט בחנויות/בתי קפה.\nנסיעה לארוגם ביי - 3 שעות.\nארוחת ערב - פיצה אצל חב\"ד גיא וילה דל מאר.\nלינה בארוגם ביי." },
        { day: '3/9', title: "ארוגם ביי", desc: "ארוחת בוקר\n1. יוגה על החוף.\n2. שיעור גלישה למתחילים / בילוי בחוף.\nארוחת צהריים\n3. שנורקלינג בשוניות באסס.\n4. סלע הפיל בשקיעה.\nארוחת ערב\nחיי לילה בארוגם ביי.\nלינה בארוגם ביי." },
        { day: '4/9', title: "שבת בארוגם ביי", desc: "ארוחת בוקר\n1. יוגה על החוף.\n2. סאפ בוקר בלגונת פוטוביל.\nארוחת צהריים קלה\nחנויות בחוף / התארגנות לשבת.\nארוחת שבת\nלינה בארוגם ביי." },
        { day: '5/9', title: "שבת", desc: "שבת\nמוצ\"ש - פעילות חוף לילית.\nלינה בארוגם ביי." },
        { day: '6/9', title: "יער יאלה", desc: "ארוחת בוקר\n1. יוגה על החוף.\n2. חנויות בחוף/זמן פנוי.\nנסיעה ליער יאלה - שעתיים.\nארוחת צהריים\n3. ספארי.\nארוחת ערב\nלינה ביאלה." },
        { day: '7/9', title: "חזרה", desc: "ארוחת בוקר\n1. יוגה.\n2. מנוחה בבריכה.\nארוחת צהריים\nנסיעה לשדה התעופה - 5-6 שעות.\nנחיתה בתל אביב יום שלישי ב-12 בצהריים." },
      ]
    },
    essentials: {
  ...
  en: {
    ...
    itinerary: {
      ...
      days: [
        { day: 'Aug 30', title: "Arrival & Sigiriya", desc: "Arrival at the Colombo Airport at 4 PM [?]\nDrive to Sigiriya, 3 hours, overnight stay" },
        { day: 'Aug 30', title: "Sigiriya", desc: "1. Climb Sigiriya Lion’s Rock Fortress for Sunrise\nBREAKFAST\n2. Visit art galleries to brows/buy\nLUNCH\n3. Elephant Safari [best between 3 and 6 - when animals are more active)\n4. Ayurvedic spas for an evening session/Village tour as an alternate activity with stop for tea\nDINNER\nOvernight Stay in Sigiriya" },
        { day: 'Aug 31', title: "Kitulgala & Nuwara Eliya", desc: "1. Sunrise hike at Pidurangala Rock (optional)\nBREAKFAST\nDrive to Kitugala (4 hours)\nLUNCH\n2. Rafting and Canyoning in Kithulgala / [alternate activity] Rainforest walk or Belilena Cave\nDrive to Nurawa Eliya 2 hours\nDINNER\nSleep in Nuwara Ella" },
        { day: 'Sep 1', title: "Ella", desc: "1. Morning yoga\nBREAKFAST\n2. Hike - either walk around Gregory Lake or Horton Plains National Park \"World's End” hike\nLUNCH\n3. Train to Ella from Nanu Oya (the station closest to Nuwara Eliya) - 12:45 PM - 2.5 hours (van drives)\n4. Visit the Nine Arches Bridge - cafe\n5. Hidden Waterfall below the hills of the Ella Town, trek through the high elevation rice fields and rocky jungle to swim the Natural polls of the Waterfall\nDINNER\nOvernight Stay in Ella" },
        { day: 'Sep 2', title: "Arugam Bay", desc: "1. Hike - Little Adams Peak\nBREAKFAST\n2. Omega Zipline\nLUNCH\n3. Walk through tea fields / Tea factory tour\n4. Browse shops/cafes\nDrive to Arugum bay - 3 hours\nDINNER - PIZZA AT CHABAD GUY villa del mar\nSleep in Arugum Bay" },
        { day: 'Sep 3', title: "Arugam Bay", desc: "BREAKFAST\n1. Yoga on the beach\n2. Beginner surf lesson / hang out on the beach\nLUNCH\n3. Snorkeling at Basses Reefs\n4. Elephant rock at sunset\nDINNER\nArugam Bay nightlife\nSleep in Arugum Bay" },
        { day: 'Sep 4', title: "Shabbat in Arugam Bay", desc: "BREAKFAST\n1. Yoga on the beach\n2. Morning sup at Pottuvil Lagoon\nLIGHT LUNCH\nBeach shops / Get ready for shabbat\nSHABBAT DINNER\nSleep in Arugum Bay" },
        { day: 'Sep 5', title: "Shabbat", desc: "Shabbat\nMotzash-Nighttime beach activity\nSleep in Arugum Bay" },
        { day: 'Sep 6', title: "Yala", desc: "BREAKFAST\n1. Yoga on the beach\n2. Beach shops/free time\nDrive to yala forest - 2 hours\nLUNCH\n3. Safari\nDINNER\nSleep in yala" },
        { day: 'Sep 7', title: "Departure", desc: "BREAKFAST\n1. Yoga\n2. Relax by the pool\nLUNCH\nDrive to airport - 5-6 hours\n\nLand in Tel Aviv Tuesday by 12 PM" },
      ]
    },
    essentials: {
