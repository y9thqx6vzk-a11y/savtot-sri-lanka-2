...
// I will extract everything EXCEPT the defaultContentData, and rebuild it cleanly.
// Actually, it's safer to just replace the entire defaultContentData.
...
export const defaultContentData = {
  he: {
    ...
    register: {
      title: 'שריינו את המקום שלכן', subtitle: 'מלאו פרטים ונחזור אליכם.', contact_wa: 'שאלות? דברו עם איל', contact_email: 'או שלחו מייל', details: ["מוגבל ל-15 משתתפות", "אין צורך בתשלום מיידי", "מדיניות ביטולים הוגנת"], form: { name: 'שם מלא', phone: 'טלפון', email: 'אימייל', guests: 'מספר משתתפים', notes: 'הערות', submit: 'שליחת בקשת הרשמה' }
    }
  },
  en: {
