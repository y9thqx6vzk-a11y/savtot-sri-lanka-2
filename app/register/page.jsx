          ...
          <div className="w-full md:w-7/12 p-10 md:p-14">
            ...
            {step === 2 && (
              <form onSubmit={handleStep2Submit} className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-bold text-teal-800">{lang === 'he' ? 'נספח א\' - Sri Lanka Trip Participant Waiver, Release and Assumption of Risk' : 'Appendix A - Sri Lanka Trip Participant Waiver, Release and Assumption of Risk'}</h4>
                  <div className="h-64 overflow-y-auto bg-stone-50 p-4 rounded-xl border border-stone-200 text-sm text-stone-700 shadow-inner">
                    <MedicalWaiver />
                  </div>
                  <label htmlFor="sectionC" className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <span className="text-stone-800 font-medium group-hover:text-teal-700">
                      {lang === 'he' ? 'קראתי, הבנתי ואני מאשר/ת את כתב הוויתור (Waiver, Release and Assumption of Risk).' : 'I have read, understood, and accept the Sri Lanka Trip Participant Waiver, Release and Assumption of Risk.'}
                    </span>
                  </label>
                </div>
