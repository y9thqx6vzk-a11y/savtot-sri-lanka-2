...
export const defaultContentData = {
  he: {
    ...
    hero: {
      title: 'סבתות בסרי לנקה\nקיץ 2026', subtitle: 'מסע נשים ייחודי בן עשרה ימים בסוף הקיץ. התוכנית נבנתה במיוחד כדי להציע שילוב אידיאלי בין חוויית חופש אותנטית, לבין נוחות מירבית, קצב נינוח וליווי מלא של טיול מאורגן.', tagline: 'טיול של פעם בחיים', cta_plan: 'צפו בתוכנית', cta_discover: 'גלו עוד'
    },
    features: {
