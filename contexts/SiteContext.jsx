...
export const defaultContentData = {
  he: {
    ...
    hero: {
      title: 'סבתות בסרי לנקה\nקיץ 2026', subtitle: 'מסע נשים ייחודי בן עשרה ימים בסוף הקיץ (30.08 עד ה-08.09). התוכנית נבנתה במיוחד כדי להציע שילוב אידיאלי בין חוויית חופש אותנטית, לבין נוחות מירבית, קצב נינוח וליווי מלא של טיול מאורגן.', tagline: 'טיול של פעם בחיים', cta_plan: 'צפו בתוכנית', cta_discover: 'גלו עוד'
    },
    features: {
  ...
  en: {
    ...
    hero: { 
      ...
      subtitle: 'A special and unforgettable experience we tailored especially for us - women looking to experience a bit of a "post-army trip", but at a relaxed pace and with all the indulgences of an organized tour. Ten days of magic at the end of the summer (August 30 - September 8).', 
